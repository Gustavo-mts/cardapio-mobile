...
public class RequestManager {
    ...
    void getRecipesDetails(RecipeDetailsListener listener, int id) {
    ...
    public void getInstructions(InstructionsListenner listenner, int id) {
        ...
        call.enqueue(new Callback<List<InstructionsResponse>>() {
            ...
            public void onResponse(Call<List<InstructionsResponse>> call, Response<List<InstructionsResponse>> response) {
                if (!response.isSuccessful()) {
                    listenner.didError(response.message());
                    return;
                }
                listenner.didFetch(response.body(), response.message());
            }

            @Override
            public void onFailure(Call<List<InstructionsResponse>> call, Throwable t) {
                listenner.didError(t.getMessage());
            }
        });
    }
