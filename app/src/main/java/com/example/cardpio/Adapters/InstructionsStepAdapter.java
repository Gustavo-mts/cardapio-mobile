...
import com.example.cardpio.Models.Step;
...
public class InstructionsStepAdapter extends RecyclerView.Adapter<InstructionStepViewHolder> {
    ...
    public void onBindViewHolder(@NonNull InstructionStepViewHolder holder, int position) {
        ...
        InstructionsIngredientsAdapter instructionIngredientsAdapter = new InstructionsIngredientsAdapter(context, list.get(position).ingredients);
        holder.recycler_instructions_ingredients.setAdapter(instructionIngredientsAdapter);

        holder.recycler_instructions_equipaments.setHasFixedSize(true);
        holder.recycler_instructions_equipaments.setLayoutManager(new LinearLayoutManager(context, LinearLayoutManager.HORIZONTAL, false));
        InstructionsEquipamentsAdapter instructionEquipamentsAdapter = new InstructionsEquipamentsAdapter(context, list.get(position).equipment);
        holder.recycler_instructions_equipaments.setAdapter(instructionEquipamentsAdapter);
...
class InstructionStepViewHolder extends RecyclerView.ViewHolder {
    ...
    RecyclerView recycler_instructions_equipaments, recycler_instructions_ingredients;
    ...
    public InstructionStepViewHolder(@NonNull View itemView) {
        ...
        recycler_instructions_equipaments = itemView.findViewById(R.id.recycler_instructions_equipaments);
