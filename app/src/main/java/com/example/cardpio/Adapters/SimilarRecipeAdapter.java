...
public class SimilarRecipeAdapter extends RecyclerView.Adapter<SimilarRecipeViewHolder>{
    ...
    RecipeClickListenner listener;

    public SimilarRecipeAdapter(Context context, List<SimilarRecipeResponse> list, RecipeClickListenner listener) {
    ...
    public void onBindViewHolder(@NonNull SimilarRecipeViewHolder holder, int position) {
        ...
        holder.textView_similar_serving.setText(list.get(position).servings+ " Pessoas");
